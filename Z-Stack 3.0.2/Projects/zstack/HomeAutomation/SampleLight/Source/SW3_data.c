...
//global attributes
const uint16 SW3_clusterRevision_all = 0x0001; //currently all cluster implementations are according to ZCL6, which has revision #1. In the future it is possible that different clusters will have different revisions, so they will have to use separate attribute variables.

// Basic Cluster
const uint8 SW3_HWRevision = SAMPLELIGHT_HWVERSION;
const uint8 SW3_ZCLVersion = SAMPLELIGHT_ZCLVERSION;
const uint8 SW3_ManufacturerName[] = { 16, 'T','e','x','a','s','I','n','s','t','r','u','m','e','n','t','s' };
const uint8 SW3_ModelId[] = { 16, 'T','I','0','0','0','1',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 SW3_DateCode[] = { 16, '2','0','0','6','0','8','3','1',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 SW3_PowerSource = POWER_SOURCE_MAINS_1_PHASE;

uint8 SW3_LocationDescription[17];
uint8 SW3_PhysicalEnvironment;
uint8 SW3_DeviceEnable;

// Identify Cluster
uint16 SW3_IdentifyTime;

// Groups Cluster
uint8 SW3_GroupsNameSupport = 0;
...
uint8  SW3_LevelCurrentLevel;
uint16 SW3_LevelRemainingTime;
uint16 SW3_LevelOnOffTransitionTime;
uint8  SW3_LevelOnLevel;
uint16 SW3_LevelOnTransitionTime;
uint16 SW3_LevelOffTransitionTime;
uint8  SW3_LevelDefaultMoveRate;
#endif

#if ZCL_DISCOVER
CONST zclCommandRec_t SW3_Cmds[] =
{
  {
...
CONST uint8 zclCmdsArraySizeSW3 = ( sizeof(SW3_Cmds) / sizeof(SW3_Cmds[0]) );
#endif // ZCL_DISCOVER
...
CONST zclAttrRec_t SW3_Attrs[] =
{
  ...
  },
  {
    ...
    {  // Attribute record
      ...
      (void *)&SW3_HWRevision  // Pointer to attribute variable
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_BASIC,
  ...
  },
  {
    ...
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&SW3_LevelOnOffTransitionTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
  ...
  },
  {
    ...
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&SW3_LevelOnTransitionTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&SW3_LevelOffTransitionTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
...
uint8 CONST SW3_NumAttributes = ( sizeof(SW3_Attrs) / sizeof(SW3_Attrs[0]) );
...
const cId_t SW3_OutClusterList[] =
{
//  ZCL_CLUSTER_ID_GEN_IDENTIFY
  ZCL_CLUSTER_ID_GEN_ON_OFF
};

#define SW3_MAX_INCLUSTERS   (sizeof(SW3_InClusterList) / sizeof(SW3_InClusterList[0]))
#define SW3_MAX_OUTCLUSTERS   (sizeof(SW3_OutClusterList) / sizeof(SW3_OutClusterList[0]))
 
SimpleDescriptionFormat_t SW3_SimpleDesc =
{
  SW3_ENDPOINT,                  //  int Endpoint;
  ...
  SW3_MAX_INCLUSTERS,         //  byte  AppNumInClusters;
  (cId_t *)SW3_InClusterList, //  byte *pAppInClusterList;
  SW3_MAX_OUTCLUSTERS,        //  byte  AppNumInClusters;
  (cId_t *)SW3_OutClusterList  //  byte *pAppInClusterList;
};
...
/*********************************************************************
 * @fn      SW3_ResetAttributesToDefaultValues
 *
 ...
 * @return  none
 */
void SW3_ResetAttributesToDefaultValues( void )
{
  int i;
  
  SW3_LocationDescription[0] = 16;
  for (i = 1; i <= 16; i++)
  {
    SW3_LocationDescription[i] = ' ';
  }
  
  SW3_PhysicalEnvironment = DEFAULT_PHYSICAL_ENVIRONMENT;
  SW3_DeviceEnable = DEFAULT_DEVICE_ENABLE_STATE;
  
#ifdef ZCL_IDENTIFY
  SW3_IdentifyTime = DEFAULT_IDENTIFY_TIME;
#endif
#ifdef ZCL_LEVEL_CTRL
  SW3_LevelCurrentLevel = DEFAULT_LEVEL;
  SW3_LevelRemainingTime = 0;
  SW3_LevelOnOffTransitionTime = DEFAULT_ON_OFF_TRANSITION_TIME;
  SW3_LevelOnLevel = DEFAULT_ON_LEVEL;
  SW3_LevelOnTransitionTime = DEFAULT_ON_TRANSITION_TIME;
  SW3_LevelOffTransitionTime = DEFAULT_OFF_TRANSITION_TIME;
  SW3_LevelDefaultMoveRate = DEFAULT_MOVE_RATE;
#endif
  SW3_OnOff = DEFAULT_ON_OFF_STATE;
